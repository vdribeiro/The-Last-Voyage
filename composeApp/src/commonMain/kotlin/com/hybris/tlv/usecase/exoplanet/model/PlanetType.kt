...
enum class PlanetType(val displayName: String) {
    // General Types
    GIANT_PLANET(displayName = "planet_type_giant_planet"),
    ...
    SUPERMASSIVE_TERRESTRIAL_PLANET(displayName = "planet_type_supermassive_terrestrial_planet"),
    MINI_NEPTUNE(displayName = "planet_type_mini_neptune"),
    SUB_NEPTUNE(displayName = "planet_type_sub_neptune"),
    ...
    // Composition Based
    SILICATE_PLANET(displayName = "planet_type_silicate_planet"),
    ...
    HABITABLE_PLANET(displayName = "planet_type_habitable_planet"),
