...
internal enum class GameOver(val displayName: String) {
    ...
    INTEGRITY_ZERO_MATERIALS_ZERO(displayName = "game_over_screen__integrity_zero_materials_zero"),
    INTEGRITY_ZERO_MATERIALS_LOW(displayName = "game_over_screen__integrity_zero_materials_low"),
    INTEGRITY_ZERO_MATERIALS_ENOUGH(displayName = "game_over_screen__integrity_zero_materials_enough"),
    ...
    FUEL_ZERO_CRYOPODS_NEAR_ZERO(displayName = "game_over_screen__fuel_zero_cryopods_near_zero"),
    FUEL_ZERO_CRYOPODS_TOO_LOW(displayName = "game_over_screen__fuel_zero_cryopods_too_low"),
