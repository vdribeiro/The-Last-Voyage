...
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_ECCENTRICITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_EQUILIBRIUM_TEMPERATURE
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_INCLINATION
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_INSOLATION_FLUX
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_MASS
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_NAME
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_OBLIQUITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_OCCULTATION_DEPTH
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_ORBITAL_PERIOD
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_ORBIT_AXIS
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_PROJECTED_OBLIQUITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_RADIUS
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.PLANET_STATUS
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_AGE
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_DEC
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_DENSITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_DISTANCE
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_GRAVITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_LUMINOSITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_MASS
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_METALLICITY
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_NAME
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_RA
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_RADIUS
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_ROTATIONAL_PERIOD
import com.hybris.tlv.domain.usecase.space.model.JsonConstants.STELLAR_HOST_ROTATIONAL_VELOCITY
...
internal class ArchiveGateway(
    ...
    private suspend fun getArchive(limit: Int = PAGE_SIZE, apiCall: suspend (Int, Int) -> Exoplanets): Exoplanets = withContext(context = Dispatcher.IO) {
        ...
        Exoplanets(stellarHosts = stellarHosts, planets = planets)
    }
    ...
    private suspend fun getPlanetarySystemsCompositeArchive(offset: Int, limit: Int): Exoplanets = withContext(context = Dispatcher.IO) {
        ...
        when (val response = httpClient.get<ExoplanetJson>(
            path = URL.ExoplanetArchive,
            queryMap = queryMap
        )) {
