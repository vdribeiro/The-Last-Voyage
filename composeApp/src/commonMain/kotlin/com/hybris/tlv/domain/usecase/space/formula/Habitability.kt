...
import com.hybris.tlv.domain.usecase.space.formula.Constants.A_RV
import com.hybris.tlv.domain.usecase.space.formula.Constants.B_EM
import com.hybris.tlv.domain.usecase.space.formula.Constants.B_MG
import com.hybris.tlv.domain.usecase.space.formula.Constants.B_RG
import com.hybris.tlv.domain.usecase.space.formula.Constants.B_RV
import com.hybris.tlv.domain.usecase.space.formula.Constants.C_EM
import com.hybris.tlv.domain.usecase.space.formula.Constants.C_MG
import com.hybris.tlv.domain.usecase.space.formula.Constants.C_RG
import com.hybris.tlv.domain.usecase.space.formula.Constants.C_RV
import com.hybris.tlv.domain.usecase.space.formula.Constants.D_EM
import com.hybris.tlv.domain.usecase.space.formula.Constants.D_MG
import com.hybris.tlv.domain.usecase.space.formula.Constants.D_RG
import com.hybris.tlv.domain.usecase.space.formula.Constants.D_RV
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_AVERAGE_DENSITY
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_DENSITY_REFERENCE
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_DENSITY_WEIGHT
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_ESCAPE_VELOCITY_REFERENCE
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_ESCAPE_VELOCITY_WEIGHT
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_INSOLATION_REFERENCE
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_INSOLATION_WEIGHT
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_RADIUS_REFERENCE
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_RADIUS_WEIGHT
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_SURFACE_TEMPERATURE_REFERENCE
import com.hybris.tlv.domain.usecase.space.formula.Constants.EARTH_SURFACE_TEMPERATURE_WEIGHT
import com.hybris.tlv.domain.usecase.space.formula.Constants.JUPITER_MASS_IN_EARTHS
import com.hybris.tlv.domain.usecase.space.formula.Constants.SUN_EFFECTIVE_TEMPERATURE
import com.hybris.tlv.domain.usecase.space.formula.Constants.SUN_INNER_BOUNDARY
import com.hybris.tlv.domain.usecase.space.formula.Constants.SUN_OUTER_BOUNDARY
import com.hybris.tlv.domain.usecase.space.formula.Constants.SUN_RADIUS_IN_AU
import com.hybris.tlv.domain.usecase.space.formula.Constants.S_EFF_SUN_EM
import com.hybris.tlv.domain.usecase.space.formula.Constants.S_EFF_SUN_MG
