...
@Composable
internal fun CreditScreen(store: com.hybris.tlv.ui.screen.Store<CreditState, Unit>) {
    ...
    _root_ide_package_.com.hybris.tlv.ui.screen.Screen(
        ...
        _root_ide_package_.com.hybris.tlv.ui.theme.component.list.CreditList(
            modifier = Modifier
                .fillMaxSize()
                .padding(all = 16.dp),
            creators = creators,
...
@Preview
@Composable
private fun CreditScreenLoadingPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
    CreditScreen(
...
@Preview
@Composable
private fun CreditScreenPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
