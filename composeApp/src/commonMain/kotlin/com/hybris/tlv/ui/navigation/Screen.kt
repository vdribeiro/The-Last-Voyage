...
internal fun NavHostController.toScreen(): Screen = runCatching {
    currentBackStackEntry?.toScreen()
}.onFailure { Telemetry.error(tag = TAG, message = "Unable to get screen", throwable = it) }.getOrNull() ?: Screen.Splash

private fun NavBackStackEntry.toScreen(): Screen? = when {
