...
@Composable
internal fun FeedbackScreen(store: com.hybris.tlv.ui.screen.Store<FeedbackState, FeedbackAction>) {
    ...
    _root_ide_package_.com.hybris.tlv.ui.screen.Screen(
        ...
        _root_ide_package_.com.hybris.tlv.ui.theme.component.container.Feedback(
            modifier = Modifier
                .fillMaxSize()
                .padding(all = 16.dp),
...
@Preview
@Composable
private fun FeedbackScreenPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
...
@Preview
@Composable
private fun FeedbackScreenThanksPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
    TranslationCache.set(
        translations = listOf(
            Translation(
                key = "error_screen__title_alt",
...
@Preview
@Composable
private fun FeedbackScreenErrorPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
    TranslationCache.set(
        translations = listOf(
            Translation(
