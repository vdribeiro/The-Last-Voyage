...
internal fun AdvancedContent(store: Store<NewGameAction, NewGameState>) {
    ...
    var planetMassUpperLimit by remember { mutableStateOf(value = storeState.math.planetMassUpperLimit.toString()) }
    var planetRadiusLowerLimit by remember { mutableStateOf(value = storeState.math.planetRadiusLowerLimit.toString()) }
    var planetRadiusUpperLimit by remember { mutableStateOf(value = storeState.math.planetRadiusUpperLimit.toString()) }
        ...
        LazyColumn(
            ...
            item {
                LabeledTextField(
                    ...
                    value = planetMassUpperLimit,
                    onValueChange = { newValue ->
                        if (newValue.isEmpty() || newValue.toDoubleOrNull()?.let { it in 0.0..9999.0 } == true) {
                            planetMassUpperLimit = newValue
                        }
                    }
                )
            }
            ...
            item {
                LabeledTextField(
                    ...
                    value = planetRadiusUpperLimit,
                    onValueChange = { newValue ->
                        if (newValue.isEmpty() || newValue.toDoubleOrNull()?.let { it in 0.0..9999.0 } == true) {
                            planetRadiusUpperLimit = newValue
                        }
                    }
                )
            }
                ...
                store.send(
                    action = NewGameAction.SelectMath(
                        math = Params.Math(
                            ...
                            planetMassUpperLimit = planetMassUpperLimit.toDouble(),
                            planetRadiusLowerLimit = planetRadiusLowerLimit.toDouble(),
                            planetRadiusUpperLimit = planetRadiusUpperLimit.toDouble(),
