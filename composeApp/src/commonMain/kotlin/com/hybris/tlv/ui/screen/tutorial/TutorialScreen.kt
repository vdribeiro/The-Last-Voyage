...
//                    modifier = Modifier
//                        .testTag(tag = TUTORIAL_SCREEN_PROGRESS_INDICATOR)
//                        .fillMaxWidth()
//                )
//
//                false -> when (storeState.currentContent) {
//                    internal const
//                            "tutorial_screen_progress_indicator"
...
//
//@Composable
//private fun Tutorial(store: Store<TutorialAction, TutorialState>) {
//    val storeState by store.stateFlow.collectAsState()
//
...
//
//        Tutorial.SYSTEM -> {
//            title = remember { getTranslation(key = "tutorial_screen__mechanics_tutorial_over_title") }
//            description = remember { getTranslation(key = "tutorial_screen__mechanics_tutorial_over_description") }
//        }
//
//        Tutorial.SYSTEM -> {
