...
@Composable
internal fun GameScreen(store: com.hybris.tlv.ui.screen.Store<GameState, GameAction>) {
    ...
    _root_ide_package_.com.hybris.tlv.ui.screen.Screen(
        ...
        bottomBar = {
            _root_ide_package_.com.hybris.tlv.ui.theme.component.bottombar.GameNavigationBar(
        ...
        when (storeState.currentContent) {
            Content.SHIP -> _root_ide_package_.com.hybris.tlv.ui.theme.component.container.ShipStats(
                modifier = Modifier
            ...
            Content.SYSTEM -> {
                ...
                _root_ide_package_.com.hybris.tlv.ui.theme.component.list.SystemList(
                    modifier = Modifier
            ...
            Content.TRAVEL -> _root_ide_package_.com.hybris.tlv.ui.theme.component.list.TravelList(
                modifier = Modifier
...
@Preview
@Composable
private fun GameScreenLoadingPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
...
@Preview
@Composable
private fun GameScreenShipPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
    TranslationCache.set(
        translations = listOf(
            Translation(
                key = "game_screen__ship",
...
@Preview
@Composable
private fun GameScreenSystemPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
    TranslationCache.set(
        translations = listOf(
            Translation(
                key = "game_screen__ship",
...
@Preview
@Composable
private fun GameScreenTravelPreview() = _root_ide_package_.com.hybris.tlv.ui.theme.AppTheme {
    TranslationCache.set(
        translations = listOf(
            Translation(
                key = "game_screen__ship",
