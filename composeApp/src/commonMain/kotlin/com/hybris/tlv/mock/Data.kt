...
internal val planets = listOf(
    ...
    Planet(
        ...
        density = 5.243,
        eccentricity = 0.0067,
        insolationFlux = 2614.0,
        equilibriumTemperature = 327.0,
        occultationDepth = null,
        inclination = 3.39,
        obliquity = 177.3,
    ),
...
internal val gameSession = GameSession(
    ...
    planetMassUpperLimit = PLANET_MASS_UPPER_LIMIT,
    planetRadiusLowerLimit = PLANET_RADIUS_LOWER_LIMIT,
    planetRadiusUpperLimit = PLANET_RADIUS_UPPER_LIMIT,
