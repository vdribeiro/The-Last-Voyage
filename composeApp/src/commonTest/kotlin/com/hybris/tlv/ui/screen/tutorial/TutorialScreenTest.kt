...
internal class TutorialScreenTest: TestCase() {
    ...
    @Test
    fun tutorial() = TestCase.runUITest {
        ...
        val navButtons = androidx.compose.ui.test.SemanticsNodeInteractionsProvider.onAllNodes(matcher = hasAnyAncestor(matcher = hasTestTag(testTag = "tutorial_navigation_bar")) and hasClickAction())
