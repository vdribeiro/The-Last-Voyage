...
internal class GameScreenTest: TestCase() {
    ...
    @Test
    fun gameWithoutData() = TestCase.runUITest {
    ...
    @Test
    fun gameWithData() = TestCase.runUITest {
        ...
        onNodeWithTag(testTag = "game_navigation_bar").assertIsDisplayed()
        val navButtons = androidx.compose.ui.test.SemanticsNodeInteractionsProvider.onAllNodes(matcher = hasAnyAncestor(matcher = hasTestTag(testTag = "game_navigation_bar")) and hasClickAction())
